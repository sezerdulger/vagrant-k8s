...
Vagrant.configure("2") do |config|
  ...
  # information on available options.
	...
	k8s_masters={
        "k8s-master-1" => "192.168.2.10",
        "k8s-master-2" => "192.168.2.11",
        "k8s-master-3" => "192.168.2.12"
    }
	k8s_cephs={
        "k8s-ceph-1" => "192.168.2.50",
        "k8s-ceph-2" => "192.168.2.51",
        "k8s-ceph-3" => "192.168.2.52"
    }
	k8s_master_lb_ip="192.168.2.5"
	
	
	config.vm.define "k8s-master-lb" do |node|
		...
		node.vm.network "private_network", ip: "#{k8s_master_lb_ip}"
